...
.setDescription(`<a:yan:1152318349703921704>   **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setTitle("Wash | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:yan:1152318349703921704>   **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
